...
local menus = { }
local keys = { up = 0x911CB09E, down = 0x4403F97F, left = 0xAD7FCC5B, right = 0x65F9EC5B, select = 0x43DBF61F, back = 0x308588E6 }
local optionCount = 0
...
local function drawTitle()
	if menus[currentMenu] then
		...
		DrawSprite("menu_textures", "translate_bg_1a", x, y+0.033, menus[currentMenu].width, titleHeight, 0.8, 161, 3, 0, 255)
...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].titleBackgroundColor = { r = 166, g = 15, b = 13, a = 150 }
	menus[id].titleBackgroundSprite = nil

	menus[id].menuTextColor = { r = 255, g = 255, b = 255, a = 255 }
	menus[id].menuSubTextColor = { r = 189, g = 189, b = 189, a = 255 }
	menus[id].menuFocusTextColor = { r = 166, g = 15, b = 13, a = 150 }
	menus[id].menuFocusBackgroundColor = { r = 245, g = 245, b = 245, a = 255 }
	menus[id].menuBackgroundColor = { r = 0, g = 0, b = 0, a = 160 }

	menus[id].subTitleBackgroundColor = { r = menus[id].menuBackgroundColor.r, g = menus[id].menuBackgroundColor.g, b = menus[id].menuBackgroundColor.b, a = 200 }
...
function WarMenu.CheckBox(text, checked, callback)
	if WarMenu.Button(text, checked and 'Aan' or 'Uit') then
		checked = not checked
